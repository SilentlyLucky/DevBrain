        ...
        <div className="relative z-10 flex flex-col h-full px-14 py-12">
          ...
          <div className="mt-14">
            ...
            <p className="text-[0.95rem] text-muted-foreground leading-relaxed max-w-[340px]">
              Save, understand, and rediscover your knowledge with AI assistance.
            </p>
          </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center relative" style={{
        ...
        <div className="w-full max-w-[520px] px-6">
          ...
          <div className="flex mb-6" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
            <span className="pb-3 px-1 mr-6 text-sm font-semibold cursor-default" style={{
              color: '#00E5FF',
              borderBottom: '2px solid #00E5FF',
            }}>Log In</span>
            <Link href="/register" className="pb-3 px-1 text-sm font-medium transition-colors border-b-2 border-transparent" style={{ color: '#7E8A9A' }}>Sign Up</Link>
          </div>
