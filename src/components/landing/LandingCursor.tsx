  ...
  useEffect(() => {
    ...
    function onOver(e: MouseEvent) {
      ...
      const interactive = target.closest(
        'a, button, [role="button"], input, textarea, [data-cursor-magnet]',
      );
    ...
    function animate() {
      halo.x += (mouse.x - halo.x) * 0.2;
      halo.y += (mouse.y - halo.y) * 0.2;
      spotlight.x += (mouse.x - spotlight.x) * 0.08;
      spotlight.y += (mouse.y - spotlight.y) * 0.08;

      pressedCurrent += (pressedTarget - pressedCurrent) * 0.3;
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          boxShadow: "0 0 10px #00E5FF, 0 0 22px rgba(0,229,255,0.5)",
          willChange: "transform, opacity",
